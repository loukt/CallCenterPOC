...
namespace CallCenterCoreAPI.Services
{
    public class CallService
    {
        ...
        private readonly string _cogServiceUri;
        private readonly ILogger<CallService> _logger;
        private AzureOpenAIService _realtimeAudioService;
        ...
        private readonly Dictionary<string, AudioStreamHandler> _audioHandlers;
        private Response<CreateCallResult> _createCallResult;
        private CallConnection _callConnection = null;
        ...
        public CallService(IConfiguration configuration, ILogger<CallService> logger)
        {
            ...
            _cogServiceUri = configuration["AzureCogService"];
        ...
        public async Task StartCallInteraction4(HttpContext httpContext)
        {

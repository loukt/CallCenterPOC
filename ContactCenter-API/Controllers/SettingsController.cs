    ...
    public class SettingsController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetSettings()
        {
            ...
            var response = new
            {
                ...
                settings.CallOverInternet,
                settings.DefaultEscalationNumber,
                settings.InboundPhoneNumber,
                settings.DefaultInboundCampaignId,
                settings.QualityCriteria,
                settings.HoldMessage,
        ...
        public async Task<IActionResult> UpdateSettings([FromBody] OperatorSettings settings)
        {
            ...
            var response = new
            {
                ...
                saved.CallOverInternet,
                saved.DefaultEscalationNumber,
                saved.InboundPhoneNumber,
                saved.DefaultInboundCampaignId,
                saved.QualityCriteria,
                saved.HoldMessage,
                VoiceLiveConfigured = _voiceLiveConfig.IsConfigured,
                AvailableVoiceLiveVoices = VoiceLiveVoices.All,
                AvailableVoiceLiveModels = OperatorSettings.ValidVoiceLiveModels.ToList()
